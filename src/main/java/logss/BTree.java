...
public class BTree<K, V> {
    ...
    private static final class Node<K, V> {
        ...
        private Entry<K, V>[] children = new Entry[M]; // the array of children
    ...
    private static class Entry<K, V> {
        private K key;
        private final V val;
        private Node<K, V> next; // helper field to iterate over array entries
    ...
    public void put(K key, V val) {
        ...
        // need to split root
        Node<K, V> t = new Node<K, V>(2);
        t.children[0] = new Entry<K, V>(root.children[0].key, null, root);
        t.children[1] = new Entry<K, V>(u.children[0].key, null, u);
        root = t;
        height++;
    }
    ...
    private Node<K, V> insert(Node<K, V> h, K key, V val, int ht) {
        int j;
        Entry<K, V> t = new Entry<K, V>(key, val, null);
    ...
    public static void main(String[] args) {
        BTree<String, String> st = new BTree<String, String>(Comparator.naturalOrder());
